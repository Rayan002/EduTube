...
public class Cpp_type extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpp_type);
        ...
        video_java.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent java_to_video = new Intent (Cpp_type.this,CpptVideo.class);
        ...
        doc_java.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent java_to_doc = new Intent (Cpp_type.this,CpptDoc.class);
        ...
        excerise_java.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent java_to_doc = new Intent (Cpp_type.this,CpptExercise.class);
                startActivity(java_to_doc);
            }
        });
    }

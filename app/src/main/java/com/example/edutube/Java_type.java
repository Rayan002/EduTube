...
public class Java_type extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_java_type);
        ...
        video_java.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent java_to_video = new Intent (Java_type.this,JavatVideo.class);
        ...
        doc_java.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent java_to_doc = new Intent (Java_type.this,JavatDoc.class);
        ...
        excerise_java.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent java_to_doc = new Intent (Java_type.this,JavatExercise.class);
                startActivity(java_to_doc);
            }
        });
    }
